...
# 3. 데이터 정의
STEPS = [
    {"id": 1, "title": "임신 확인 및 초기 응대", "short": "임신 확인", "color": "#4FACCC", "guide": "“축하드립니다! 임신 소식은 본인이 원하는 범위 내에서만 공유될 예정이니 안심하세요. 먼저 단축근무 제도부터 안내해 드릴까요?”", "check": ["공유 희망 범위 확인 (비밀유지)", "단축근무 신청 방법 및 서류 안내", "플로우 내 신청서 경로 설명"], "forms": ["임신확인서", "KCIM_지원 신청서"], "warn": ["비밀유지 의무 준수 필수", "임신 이유 불이익 금지"], "target": "임신 확인 직원", "next": "단축 조율"},
    {"id": 2, "title": "임신기 근로시간 단축", "short": "임신기 단축", "color": "#37B89A", "guide": "“이제 임신 후 12주 이내 / 32주 이후 단축 근무가 가능합니다. 하루 2시간을 자유롭게 사용하실 수 있습니다.”", "check": ["임신 12주 이내 또는 32주 이후 확인", "단축 시간대 협의", "팀 내 업무 조정 지원"], "forms": ["임신기 단축신청서"], "warn": ["개정: 32주 확대 적용", "고위험군은 전 기간 가능"], "target": "단축 희망 직원", "next": "검진 안내"},
    {"id": 3, "title": "정기 건강진단 (태아검진)", "short": "건강진단", "color": "#F5A623", "guide": "“검진 시간은 유급으로 보장됩니다. 플로우 양식 신청서만 작성해 주시면 팀장님께 공유해 드릴게요.”", "check": ["검진 주기별 시간 부여", "유급 인정 및 증빙 안내", "신청 경로 가이드"], "forms": ["지원 신청서"], "warn": ["진료 영수증 등 증빙 확인", "사용 불이익 금지"], "target": "검진 대상자", "next": "연차 조율"},
    {"id": 4, "title": "연차 정리 및 인수인계", "short": "연차 정리", "color": "#9B59B6", "guide": "“출산휴가 전 남은 연차를 사용해 일찍 휴식을 시작하실 수 있습니다. 인수인계 시점을 알려주세요.”", "check": ["잔여 연차 계산", "출산휴가 시작일 확정", "인수인계 리스트 작성"], "forms": ["연차 신청서"], "warn": ["연차 강제 소진 금지", "자율권 존중"], "target": "휴가 예정자", "next": "출산/배우자 휴가"},
    {"id": 5, "title": "출산 전후 및 배우자 휴가", "short": "출산 관련", "color": "#E8556D", "guide": "“출산휴가는 90일, 배우자분은 20일 유급 휴가가 가능합니다. 미숙아 출산 시 100일이 적용됩니다.”", "check": ["배우자 휴가(20일) 안내", "미숙아 출산(100일) 확인", "유산·사산 휴가 안내"], "forms": ["어울지기 내 신청"], "warn": ["산후 45일 보장 필수", "배우자 휴가 120일 내 사용"], "target": "출산 전후 직원", "next": "육아기 지원"},
