...
# ──────────────────────────────────────────
# 데이터 정의 (2026-08 기준, 노무법인 인화 매뉴얼 2026.03 1판 + 사내 노무사 검토 반영)
# ──────────────────────────────────────────
STEPS = [
    {
        ...
        "guide": '"축하드립니다! 원하시면 임신 소식은 본인이 원하는 범위 내에서만 공유되도록 회사 차원에서 배려해 드릴게요. 먼저 단축근무 제도부터 안내해 드릴까요?"',
        "check": ["공유 희망 범위 확인 (법적 의무는 아닌 회사 차원의 배려 안내)", "단축근무 신청 방법 및 서류 안내", "플로우 내 신청서 경로 설명"],
        "forms": ["임신확인서", "KCIM_임신·육아기 관련 지원 신청서"],
        "warn": ["임신 사실은 법정 비밀유지 의무 대상 아님(법정 의무는 난임치료에 한함) — 본인 요청 시 배려 차원 안내", "임신 이유로 불이익 주는 행위 금지"],
        "laws": [
            {"name": "근로기준법 제74조", "desc": "임신기 근로시간 단축 및 보호"},
            {"name": "남녀고용평등법 제14조", "desc": "직장 내 모성보호 불이익 금지"},
        ],
        "faq": [
            {"q": "직원이 임신 사실을 비밀로 해달라고 하면?", "a": "법적으로 비밀유지 의무가 있는 사항은 아니지만(법정 의무는 난임치료에 한함), 본인이 원하시면 회사 차원에서 공유 범위를 최대한 배려해 드릴 수 있습니다."},
    ...
    },
    {
        ...
        "guide": '"임신 12주 이내(84일까지) 또는 32주 이후(246일 이후)에 하루 2시간 단축 근무가 가능합니다. 통상임금은 전액 유지되고, 출퇴근 시간 조정이나 쉬운 업무 전환도 함께 신청하실 수 있어요."',
        ...
        "warn": ["2025 개정: 32주 이후로 확대 적용", "고위험 임산부는 전 기간 단축 가능 (법령상 정해진 특정 질환 대상자인지 확인 가능한 진단서 필요 — 진단서 제출만으로 자동 인정되는 것은 아님)", "단축 개시 3일 전 신청 원칙 — 늦으면 접수일+3일부터 적용"],
        "laws": [
            {"name": "근로기준법 제74조의2", "desc": "임신기 근로시간 단축 (12주 이내/32주 이후, 1일 최대 2시간·6시간까지)"},
            {"name": "모자보건법 제10조", "desc": "고위험 임산부 추가 보호"},
        ],
        "faq": [
            {"q": "단축 중 급여는 어떻게 되나요?", "a": "단축 근무 기간에도 통상임금은 전액 지급됩니다. 다만 포괄임금제로 연장근로수당이 포함돼 있었다면, 임신 중 연장근로가 절대 금지되므로 해당 수당은 지급하지 않을 수 있습니다 (다만 회사 재량으로 전액 지급하는 것도 가능합니다)."},
            {"q": "12주~32주 사이에는 단축이 불가한가요?", "a": "일반적으로는 불가하나, 법령상 정해진 특정 질환의 고위험 임산부로 진단받은 경우 전 기간 가능합니다. 진단서만으로 자동 인정되는 것은 아니고 해당 질환 대상자인지 확인이 필요합니다."},
    ...
    },
    {
        ...
        "forms": ["어울지기 내 신청"],
        "warn": ["일방적으로 연차를 소진 처리하는 것은 금지 (사용 권장·협의 자체는 가능)", "직원의 자율권 존중"],
        "laws": [
            {"name": "근로기준법 제60조", "desc": "연차 유급휴가 자율 사용 원칙"},
        ],
        "faq": [
            {"q": "출산휴가 전 연차를 다 소진해야 하나요?", "a": "연차는 원칙적으로 직원이 원하는 시점에 자유롭게 사용합니다. 다만 업무상 필요에 따라 회사가 사용을 권장하거나 협의하는 것 자체는 위법이 아니며, 동의 없이 일방적으로 연차를 소진 처리하는 경우만 위법입니다."},
    ...
    },
    {
        ...
        "guide": '"출산휴가는 90일(다태아 120일, 미숙아 100일)이며 원칙적으로 연속 사용합니다. 배우자분은 근무일 기준 20일 유급 휴가가 보장되고 최대 3번 나눠 쓸 수 있어요. 출산 후 45일은 반드시 쉬셔야 합니다."',
        "check": ["배우자 출산휴가(20일, 최대 3회 분할) 신청 안내", "미숙아·다태아 출산 여부 확인 (100일/120일)", "유산·사산 휴가 해당 여부 및 임신주수 확인"],
        "forms": ["어울지기 내 신청", "출산전후휴가 확인서", "배우자출산휴가 확인서"],
        "warn": ["산후 45일 이상 반드시 보장 (위반 시 2년 이하 징역 또는 2천만원 이하 벌금)", "배우자 휴가는 출산 후 120일 이내 사용", "⚠️ 2026-09-18 시행 예정: 배우자출산휴가 → '배우자출산전후휴가'로 명칭 변경, 출산예정일 50일 전부터 사용 가능하도록 확대(20일·최대 3회 분할 유지) — 시행 전이므로 현재는 종전 기준 적용"],
        "laws": [
            {"name": "근로기준법 제74조", "desc": "출산전후 휴가 90일(다태아 120일·미숙아 100일), 원칙적 연속 사용, 산후 반드시 45일 이상"},
            {"name": "남녀고용평등법 제18조의2", "desc": "배우자 출산휴가 20일(근무일 기준) 유급, 최대 3회 분할 가능"},
        ],
        "faq": [
            {"q": "출산휴가도 나눠 쓸 수 있나요?", "a": "출산휴가는 원칙적으로 연속 사용이 원칙입니다. 나눠 쓰는 것(최대 3회 분할)은 배우자 출산휴가에 한해 가능하니 두 제도를 혼동하지 않도록 안내해 주세요."},
            {"q": "배우자 출산휴가 20일은 연속으로 써야 하나요?", "a": "아니요. 최대 3번까지 나눠 총 4번에 걸쳐 사용 가능합니다. 단, 출산일로부터 120일 이내에 모두 사용해야 합니다."},
        ...
        "kpi": [{"val": "90일", "label": "출산휴가(연속 원칙)"}, {"val": "20일", "label": "배우자휴가(최대3회 분할)"}],
    },
    {
        ...
        "faq": [
            ...
            {"q": "단축 근무 중 급여는 어떻게 계산되나요?", "a": "단축 시간에 비례해 회사가 통상임금 기준으로 임금을 지급하고, 고용보험에서 육아기 근로시간 단축 급여(첫 10시간분 통상임금 100%·상한 250만원, 나머지 통상임금 80%·상한 160만원)를 별도 지원합니다."},
    ...
    },
    {
        ...
        "kpi": [{"val": "1년 6개월", "label": "육아휴직(조건부 최대)"}, {"val": "1~2주", "label": "단기 육아휴직(연1회)"}],
    },
    {
        "id": 7, "short": "가족돌봄", "title": "가족돌봄휴직 및 휴가",
        "color": "#64748b", "grad": "linear-gradient(135deg, #475569, #64748b)",
        "target": "가족돌봄 필요 직원", "next": "난임치료 안내(참고)",
        "guide": '"조부모·부모·배우자·배우자의 부모·자녀·손자녀의 질병·사고·노령으로 돌봐야 하는 경우 연간 최대 90일 휴직이 가능하고, 자녀 양육 등 사유로 급하게 하루 이틀만 필요하면 그 안에서 연 10일은 휴가 형태로 쓰실 수 있어요."',
        "check": ["돌봄 대상 가족관계 및 질병·사고·노령 사유 확인", "휴직(30일 이상 단위) vs 휴가(1일 단위, 연 10일, 자�녀 양육 사유도 추가 인정) 구분 안내", "감염병·휴원 등 특별사유 해당 여부 확인(+10일 가능)"],
        ...
        "laws": [
            {"name": "남녀고용평등법 제22조의2", "desc": "가족돌봄휴직 연 90일(분할 시 1회 30일 이상) — 가족의 질병·사고·노령 사유에 한함"},
            {"name": "동법 제22조의3", "desc": "가족돌봄휴가 연 10일(1일 단위, 특별사유 시 +10일) — 질병·사고·노령 외에 자녀 양육 사유도 인정"},
        ],
        "faq": [
            {"q": "휴직과 휴가의 차이는 뭔가요?", "a": "휴직은 가족의 질병·사고·노령을 사유로 30일 이상 단위로 사용합니다. 휴가는 같은 사유에 더해 자녀 양육 사유도 인정되며, 1일 단위로 급하게 쓸 수 있습니다. 둘을 합쳐 연 90일 한도 안에서 운용됩니다."},
            {"q": "단순히 아이를 돌보고 싶어서 휴직을 쓸 수 있나요?", "a": "가족돌봄휴직은 질병·사고·노령 사유만 인정되어 단순 양육 목적으로는 신청할 수 없습니다. 자녀 양육 사유는 가족돌봄휴가(연 10일, 1일 단위)에서만 추가로 인정됩니다."},
...
# ──────────────────────────────────────────
# 스텝 프로그레스 (항상 표시, 계산기 모드에서도 유지 — 계산기 버튼을
# STEP 8 바로 옆에 마지막 알약으로 붙여서 언제든 오갈 수 있게 함)
# ──────────────────────────────────────────
with st.container(key="stepper_wrap_box"):
    with st.container(horizontal=True, gap="small"):
        ...
        calc_key_state = "step_active" if is_calc else "step_todo"
        if st.button(
            "📊 계산기",
            key=f"{calc_key_state}_calc",
            help="법정 기간 계산기 열기",
        ):
...
[답변 원칙]
1. 최신 개정 반영: 임신기 단축 32주(통상임금 전액 유지, 고위험 임산부는 법령상 특정 질환 대상자에 한해 전 기간 가능), 출산휴가 90일(원칙 연속 사용)과 배우자출산휴가 20일(최대 3회 분할)은 서로 다른 제도이므로 절대 혼동하지 말 것, 육아기 근로시간 단축 급여는 통상임금 기준(첫 10시간 100%·이후 80%), 육아휴직 기본 1년+조건부 6개월(1년 6개월, 부모 각각 3개월+ 사용 또는 한부모·중증장애아동 부모만 해당), 사후지급금 폐지, 6+6 부모육아휴직제(자녀 생후 18개월 이내, 동시/순차 사용 시 첫 6개월 100% 지급), 난임치료휴가 연 6일(2일 유급, 법정 비밀유지 의무는 이 제도에 한함 — 임신 사실 자체는 법정 비밀유지 의무 대상 아님), 가족돌봄휴직은 가족의 질병·사고·노령 사유에 한하고 가족돌봄휴가(연 10일)만 자녀 양육 사유 추가 인정, 연차는 회사가 사용을 권장·협의하는 것 자체는 위법이 아니며 동의 없는 일방적 소진 처리만 위법, 단기 육아휴직(2026-08-20 시행, 만 8세 이하 자녀 단기 돌봄 시 연 1회 1주/2주 단위, 전체 육아휴직 기간에서 차감). 단, 2026-09-18 시행 예정 사항(배우자출산전후휴가 명칭변경 및 출산예정일 50일 전부터 사용 가능하도록 확대, 배우자 유산·사산휴가 신설, 배우자 유산·조산 위험 시 남성 육아휴직 확대)은 아직 시행 전이므로 시행일을 함께 안내할 것
