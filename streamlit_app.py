...
faq_pool = [
    {
        ...
        "a": "임신 후 <span class='point'>12주 이내</span> 또는 <span class='point'>32주 이후</span>인지 확인하십시오. [cite: 13, 76] 임금 삭감 없이 하루 2시간 단축이 가능하며, 고위험 임신부는 전 기간 사용 가능함을 안내해야 합니다. [cite: 13, 77]"
    },
    {
        "cat": "👨‍🍼 배우자 출산휴가", 
        "q": "배우자 출산휴가 기간과 분할 사용에 대해 묻는다면?", 
        "a": "25.2.23. 이후 <span class='point'>유급 20일</span>로 확대되었습니다. [cite: 27, 103] 출산일로부터 120일 내에 사용 완료해야 하며, <span class='point'>총 4회(분할 3회)</span>까지 나누어 쓸 수 있어 유연한 육아 참여가 가능합니다. [cite: 30, 106]"
    },
    {
        "cat": "🤱 육아휴직 및 단축", 
        "q": "초등 고학년 자녀를 둔 직원의 단축근무가 가능한가요?", 
        "a": "<b>네, 가능합니다.</b> 대상 자녀 연령이 <span class='point'>만 12세 또는 초등 6학년 이하</span>로 확대되었습니다. [cite: 48, 118] 육아휴직 미사용분 포함 시 최대 3년까지 사용 가능함을 안내하십시오. [cite: 45, 119]"
    },
    {
        "cat": "💰 급여 및 복직 가이드", 
        "q": "복직 예정자가 사후지급금(25%) 수령 시점을 문의한다면?", 
        "a": "2025년 1월 1일 이후 사용분부터 <span class='point'>사후지급금 제도가 폐지</span>되었습니다. [cite: 41, 113, 257] 이제 복직 후 6개월 대기 없이 휴직 중에 급여 100%를 즉시 수령하게 됨을 안내하여 경제적 안정을 강조하십시오. [cite: 297]"
    }
]
