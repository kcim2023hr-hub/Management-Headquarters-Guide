...
STEPS = [
    ...
    },
    {
        ...
        "guide": "직원 주수와 적용 가능 시기(12주 이내/32주 이후)를 먼저 확인한 뒤 신청서 접수와 단축 시간대를 같이 조율해 주세요.",
        "check": [
            "적용 가능 시기(12주 이내 / 32주 이후)와 신청 사유 먼저 확인하기",
            "신청서 및 임신확인서 등 구비서류 안내하기",
            "임금 삭감 금지 원칙 안내하기",
            "팀장과 실무 인수 범위 공유하기",
        ],
