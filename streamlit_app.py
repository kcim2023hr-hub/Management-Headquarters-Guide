...
STEPS = [
    {
        ...
        "next_step": "단축근무 여부 확인", "target": "임신 확인한 임직원"
    },
    {
...
with main_col:
    ...
    with tab_guide:
        # ✅ HTML 내부의 모든 줄을 왼쪽으로 붙여서 마크다운 오인식을 방지함
        st.markdown(
f"""
        ...
        if prompt := st.chat_input("질문을 입력하세요..."):
            ...
            try:
                ...
                response = client.chat.completions.create(
                    model="gpt-4o",
                    messages=[{"role": "system", "content": "너는 KCIM HR 챗봇이다."}, *st.session_state.chat_messages],
                )
